...
export const PopUpTweet = () => {
  ...
  <div className="popup-tweet-top-area"
    ...
    <img src="/close.png" alt="closebtn" className="popup-tweet-top-area-close-btn"></img>
  </div>
  <div className="popup-tweet-center-area">
    <div className="popup-twee-LeftArea">
      <img className="popup-tweet-user-photo" src="/user.png" alt="popup-tweet-photo"></img>
    </div>
